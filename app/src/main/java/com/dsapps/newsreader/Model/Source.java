...
public class Source {
    ...
    public Source(String id, String name, String description, String category, String url, String language, String country, UrlsToLogos urlsToLogos, List<String> sortByAvailable) {
        this.id = id;
        this.name = name;
